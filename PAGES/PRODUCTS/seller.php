            ...
            <form action="" method="post" id="regFormSeller">
                ...
                <div class="form_items">
                    ...
                    <div class="items_inner">
                        ...
                        <input type="text" placeholder="Enter your First Name" id="fname" name="fname" autocomplete="off">
                ...
                <div class="form_items">
                    ...
                    <div class="items_inner">
                        ...
                        <input type="text" placeholder="Enter your LastName" id="lname" name="fname" autocomplete="off">
                ...
                <div class="form_items">
                    ...
                    <div class="items_inner">
                        <img src="ASSETS/SIMAGES/Phone.png" alt="PHONE">
                        <input type="text" placeholder="Enter your Phone Number" id="pnum" name="pnum" autocomplete="off">
                ...
                <div class="form_items">
                    ...
                    <div class="items_inner">
                        <img src="ASSETS/SIMAGES/Key.png" alt="KEY">
                        <input type="Password" placeholder="Create a Password"  id="password" name="password" autocomplete="off">
                ...
                <div class="form_items">
                    ...
                    <div class="items_inner">
                        <img src="ASSETS/SIMAGES/Key.png" alt="KEY">
                        <input type="Password" placeholder="Confirm your Password" id="cpassword" name="cpassword" autocomplete="off">
